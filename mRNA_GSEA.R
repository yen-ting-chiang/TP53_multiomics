...
#
# Uses moderated-t statistics from mRNA_differential_analysis/ as ranking
#
...
# Input: mRNA DEG results
deg_dir <- file.path(base_path, "mRNA_differential_analysis")

# Output: GSEA results
output_dir <- file.path(base_path, "mRNA_GSEA")
